...
dynamic-datasource is a dynamicDataSource bean definition registrar, it will auto configure DataSource with Reading and Writing separation. The configurations like:
```
